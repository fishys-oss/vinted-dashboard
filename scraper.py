...
def get_vinted_items():
                ...
                if price_elem:
                    ...
                    if link_elem and "href" in link_elem.attrs:
                        ...
                        url = (
                            ...
                            else f"https://www.vinted.fr{href}"
                        )
    ...
    if not current_items and previous_items:
        print(
            "Avertissement: Aucun article récupéré. Conservation de l'ancien"
            " état."
        )
        return
    ...
    # Sauvegarde des données articles
    with open(DATA_FILE, "w", encoding="utf-8") as f:
        json.dump(final_items, f, indent=2, ensure_ascii=False)

    # Sauvegarde de l'heure exacte de la dernière synchro pour le compteur du site
